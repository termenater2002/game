...
namespace Unity.AppUI.Core
{
    ...
    /// </code>
    /// <para>
    /// If you want to handle dropping items, you can use the <see cref="Unity.Muse.AppUI.UI.DropZone"/> UI element,
    /// or the <see cref="Unity.Muse.AppUI.UI.DropZoneController"/> controller for a lower-level approach.
    /// </para>
    /// <code>
    /// using Unity.AppUI.Core;
    /// using Unity.Muse.AppUI.UI;
    ///
    /// internal class MyMainView : VisualElement
    /// {
    ///     public MyMainView()
    ///     {
