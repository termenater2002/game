...
{
    static partial class TextToMotionAPI
    {
		public static string ApiName => $"/api/v2/animate/organizations/{AccountInfo.Instance.Organization.Id}/text_to_motion";
        ...
        public class Response : IDisposable, IDeserializable<JObject>
        {
            ...
            public void Deserialize(JObject data)
            {
                ...
                m_Temperature = serializedResponse.Temperature;
            }
        }
    }
}
