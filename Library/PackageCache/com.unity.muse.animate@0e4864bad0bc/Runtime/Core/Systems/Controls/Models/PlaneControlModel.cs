...
{
    [Serializable]
    class PlaneControlModel
    {
        [SerializeField]
        PlaneControlData m_Data;
        ...
        public delegate void TransformChanged(PlaneControlModel controlModel, Vector3 newPosition, Quaternion newRotation);
        public event TransformChanged OnTransformChanged;

        public delegate void ColorChanged(PlaneControlModel controlModel);
        public event ColorChanged OnColorChanged;

        public PlaneControlModel(Vector3 firstLocalAxis, Vector3 secondLocalAxis, Color firstAxisColor, Color secondAxisColor, Color normalColor) :
            this(firstAxisColor, secondAxisColor, normalColor)
        {
        ...
        public PlaneControlModel(Color firstAxisColor, Color secondAxisColor, Color normalColor)
        {
        ...
        [JsonConstructor]
        public PlaneControlModel(PlaneControlData m_Data)
        {
            this.m_Data = m_Data;
        }
