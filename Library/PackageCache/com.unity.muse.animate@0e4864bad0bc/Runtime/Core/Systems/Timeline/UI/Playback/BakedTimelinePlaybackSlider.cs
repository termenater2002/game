...
namespace Unity.Muse.Animate
{
    ...
    [UxmlElement]
#endif
    partial class BakedTimelinePlaybackSlider : AppUI.UI.BaseSlider<int,int>
    {
#if ENABLE_UXML_TRAITS
        /// <summary>
        /// Factory class to instantiate a <see cref="BakedTimelinePlaybackSlider"/> using the data read from a UXML file.
        /// </summary>
        [Preserve]
        public new class UxmlFactory : UxmlFactory<BakedTimelinePlaybackSlider, UxmlTraits> { }
#endif

        /// <summary>
        /// The Slider main styling class.
        /// </summary>
        public static readonly string ussClassName = "deeppose-baked-timeline-playback-slider";
        ...
        /// Default constructor.
        /// </summary>
        public BakedTimelinePlaybackSlider()
        {
        ...
        void OnKeyDown(KeyDownEvent evt)
        {
            if (evt.target == this && focusController.focusedElement == this)
            {
                ...
                if (handled)
                {
                    ...
                    using var changingEvt = ChangingEvent<int>.GetPooled();
...
#if ENABLE_UXML_TRAITS
        /// <summary>
        /// Class containing the <see cref="UIElements.UxmlTraits"/> for the <see cref="UnityEngine.Dt.App.UI.SliderBase{TValueType}"/>.
        /// </summary>
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            readonly UxmlIntAttributeDescription m_HighValue = new ()
            {
                name = "high-value",
                defaultValue = 100
            };

            readonly UxmlIntAttributeDescription m_LowValue = new ()
            {
                name = "low-value",
                defaultValue = 0
            };

            readonly UxmlIntAttributeDescription m_Value = new ()
            {
                name = "value",
                defaultValue = 0
            };
            ...
            readonly UxmlBoolAttributeDescription m_Primary = new ()
            {
                name = "primary",
                defaultValue = false
            };

            readonly UxmlBoolAttributeDescription m_Filled = new ()
            {
                name = "filled",
                defaultValue = false
            };

            readonly UxmlIntAttributeDescription m_FillStart = new ()
            {
                name = "fill-start",
                defaultValue = 0
            };

            readonly UxmlIntAttributeDescription m_FillEnd = new ()
            {
                name = "fill-end",
                defaultValue = 0
            };
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                var el = (BakedTimelinePlaybackSlider)ve;
