...
{
    /// <summary>
    /// ContextualCompletionRequest
    /// </summary>
    [DataContract(Name = "ContextualCompletionRequest")]
    internal partial class ContextualCompletionRequest
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="ContextualCompletionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContextualCompletionRequest() { }
        public ContextualCompletionRequest(string organizationId, string prompt, bool streamResponse)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContextualCompletionRequest {\n");
