...
namespace Unity.Muse.Chat.BackendApi.Model
{
    ...
    internal partial class CodeGenRequest
    {
        ...
        protected CodeGenRequest() { }
        public CodeGenRequest(string organizationId, string prompt, bool streamResponse)
        {
        ...
        /// <summary>
        /// Gets or Sets UserCodeExamples
        /// </summary>
        [DataMember(Name = "user_code_examples", EmitDefaultValue = true)]
        public string UserCodeExamples { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UserCodeExamples: ").Append(UserCodeExamples).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
